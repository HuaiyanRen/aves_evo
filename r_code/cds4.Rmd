...
```{r}
ggtree(cds4mix_tree, branch.length = 'none', aes(color = lab))+
  geom_tree()+
  geom_tree(data = d2)+
  geom_tiplab(size = 1.5)+
  geom_nodelab(size = 1.5, nudge_x = -0.5, nudge_y = 0.6)+
...
grp <- list(a_Palaeognathae_1 = d2[[4]][345:363],
            b_Galloanseres_2 = d2[[4]][1:18],
            c_Mirandornithes_3 = d2[[4]][19:21],
            d_Columbimorphae_4 = d2[[4]][323:331],
            e_Otidimorphae_5 = d2[[4]][332:344],
            f_Opisthocomiformes_6 = d2[[4]][286],
            g_Cursorimorphae_7 = d2[[4]][287:322],
            h_Strisores_8 = d2[[4]][274:285],
            i_Phaethontimorphae_9 = d2[[4]][244:246],
            j_Aequornithes_10 = d2[[4]][247:273],
            k_Afroaves_11 = d2[[4]][206:243],
            l_Australaves_12 = d2[[4]][19:205]
            )
