...
```{r}
tree1 <- groupOTU(main_tree, grp, 'clade')
tree2 <- groupOTU(ref_chr1_tree, grp, 'clade')
...
```{r}
output_path <- "C:/Users/u7151703/OneDrive - Australian National University/Desktop/research/aves_evo/draft_results/inter/refchr1_vs_main.pdf"
