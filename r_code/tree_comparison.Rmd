...
```{r}
main_tree <- root(main_tree, outgroup = 'STRCAM', edgelabel = TRUE)
exon_tree <- root(mixc123_tree, outgroup = 'STRCAM', edgelabel = TRUE)
...
```{r}
tree1 <- groupOTU(partc123_tree, grp, 'clade')
tree2 <- groupOTU(partc123_2k_tree, grp, 'clade')
...
```{r}
output_path <- "C:/Users/u7151703/OneDrive - Australian National University/Desktop/research/aves_evo/draft_results/exon1k/mix12_vs_main.pdf"
