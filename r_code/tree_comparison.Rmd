...
```{r}
tree1 <- groupOTU(exon363_tree, grp, 'clade')
tree2 <- groupOTU(mix12_1k_tree, grp, 'clade')
...
```{r}
output_path <- "C:/Users/u7151703/OneDrive - Australian National University/Desktop/research/aves_evo/draft_results/full/mix12_1k_vs_exon.pdf"
